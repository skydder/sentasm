pub const VERB: &[&'static str] = &["add", "substract", "multiply", "divide", "move", "jump", "and", "or", "xor", "not", "negate", "shift_right", "shift_left", "call", "compare", "load_effective_address", "push", "pop", "set_byte", "extend_acc_reg", "return", "halt", "leave", "no_operation", "systemcall"];
pub const PREPOSITION: &[&'static str] = &["to", "from", "by", "as", "with", "if", "for"];
pub const KEYWORD: &[&'static str] = &["single_precision_float", "double_precision_float", "sign_extention", "zero_extention", "signed", "==", "!=", "<", "<=", ">", ">=", "8bit", "16bit", "32bit", "64bit"];
