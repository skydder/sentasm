use data::{
	Keyword, Register, Immediate, Memory, Data, DataSet, Preposition, Result, Verb, Sentence, Label
};
use macros::{match_data, get_prep_object, make_operands};
...
fn gen_ins_move(sentence: Sentence) -> Result<String> {
	...
	match (&_obj, &_to, &_as, &_with) {
		...
		(match_data!(Register(_, 8 | 0, ..)) | match_data!(Memory{size:8 | 0, ..}), match_data!(Register(_, 16 | 0, ..)), None, match_data!(Keyword("sign_extention"))) => Ok(nasm("movsx", make_operands!(_to, _obj))),
		(match_data!(Register(_, 8 | 0, ..)) | match_data!(Memory{size:8 | 0, ..}), match_data!(Register(_, 32 | 0, ..)), None, match_data!(Keyword("sign_extention"))) => Ok(nasm("movsx", make_operands!(_to, _obj))),
		(match_data!(Register(_, 8 | 0, ..)) | match_data!(Memory{size:8 | 0, ..}), match_data!(Register(_, 64 | 0, ..)), None, match_data!(Keyword("sign_extention"))) => Ok(nasm("movsx", make_operands!(_to, _obj))),
		(match_data!(Register(_, 16 | 0, ..)) | match_data!(Memory{size:16 | 0, ..}), match_data!(Register(_, 32 | 0, ..)), None, match_data!(Keyword("sign_extention"))) => Ok(nasm("movsx", make_operands!(_to, _obj))),
		(match_data!(Register(_, 16 | 0, ..)) | match_data!(Memory{size:16 | 0, ..}), match_data!(Register(_, 64 | 0, ..)), None, match_data!(Keyword("sign_extention"))) => Ok(nasm("movsx", make_operands!(_to, _obj))),
		(match_data!(Register(_, 16 | 0, ..)) | match_data!(Memory{size:16 | 0, ..}), match_data!(Register(_, 16 | 0, ..)), None, match_data!(Keyword("sign_extention"))) => Ok(nasm("movsxd", make_operands!(_to, _obj))),
		(match_data!(Register(_, 32 | 0, ..)) | match_data!(Memory{size:32 | 0, ..}), match_data!(Register(_, 32 | 0, ..)), None, match_data!(Keyword("sign_extention"))) => Ok(nasm("movsxd", make_operands!(_to, _obj))),
		(match_data!(Register(_, 32 | 0, ..)) | match_data!(Memory{size:32 | 0, ..}), match_data!(Register(_, 64 | 0, ..)), None, match_data!(Keyword("sign_extention"))) => Ok(nasm("movsxd", make_operands!(_to, _obj))),
		(match_data!(Register(_, 8 | 0, ..)) | match_data!(Memory{size:8 | 0, ..}), match_data!(Register(_, 16 | 0, ..)), None, match_data!(Keyword("zero_extention"))) => Ok(nasm("movzx", make_operands!(_to, _obj))),
		(match_data!(Register(_, 8 | 0, ..)) | match_data!(Memory{size:8 | 0, ..}), match_data!(Register(_, 32 | 0, ..)), None, match_data!(Keyword("zero_extention"))) => Ok(nasm("movzx", make_operands!(_to, _obj))),
		(match_data!(Register(_, 8 | 0, ..)) | match_data!(Memory{size:8 | 0, ..}), match_data!(Register(_, 64 | 0, ..)), None, match_data!(Keyword("zero_extention"))) => Ok(nasm("movzx", make_operands!(_to, _obj))),
		(match_data!(Register(_, 16 | 0, ..)) | match_data!(Memory{size:16 | 0, ..}), match_data!(Register(_, 32 | 0, ..)), None, match_data!(Keyword("zero_extention"))) => Ok(nasm("movzx", make_operands!(_to, _obj))),
		(match_data!(Register(_, 16 | 0, ..)) | match_data!(Memory{size:16 | 0, ..}), match_data!(Register(_, 64 | 0, ..)), None, match_data!(Keyword("zero_extention"))) => Ok(nasm("movzx", make_operands!(_to, _obj))),
		_ => {
			emit_error!(sentence.location, "unmatched operand");
			Err(())
		},
