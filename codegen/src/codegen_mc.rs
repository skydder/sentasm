...
use data::{Data, DataSet, Immediate, Memory, RegType, Register};
    ...
    match (ins_name, &operands) {
        (
            ...
            Operands(
                ...
                match_data!(Register(_, 64, _, _, _)),
                None,
                None,
            ),
        ) => {
        ...
        (
            "adc",
            Operands(
                match_data!(Register(_, 64, _, _, _)) | match_data!(Memory { size: 64, .. }),
                match_data!(Immediate(_, 8, ..)),
                None,
                None,
            ),
        ) => {
        ...
        (
            "adc",
            Operands(
                match_data!(Register(_, 64, 0, _, _)),
                match_data!(Immediate(_, _, true)),
                None,
                None,
            ),
        ) => {
        ...
        (
            "call",
            Operands(
                match_data!(Register(_, _, _, _, _)) | match_data!(Memory { size: _, .. }),
                None,
                None,
                None,
            ),
        ...
        (
            ...
            // r+mi
            // [['r', 'm'], ['i']]
            let _r = operands.0.clone().unwrap();
            let _m = operands.0.unwrap();
            let _i = operands.1.unwrap();
            ins.set_rex_w();
            ins.set_opcode(0x6b);
        ...
        (
            "lar",
            Operands(
                match_data!(Register(_, 16, _, _, _)),
                match_data!(Register(_, 64, _, _, _)),
                None,
                None,
            ),
        ...
        (
            "lar",
            Operands(
                match_data!(Register(_, 32, _, _, _)),
                match_data!(Register(_, 64, _, _, _)),
                None,
                None,
            ),
        ...
        (
            ...
            Operands(
                match_data!(Immediate(_, _, ..)),
                match_data!(Register(_, 64, 1, _, _)),
                None,
                None,
            ),
        ) => {
        ...
        (
            ...
            Operands(
                match_data!(Register(_, 64, 0, _, _)),
                match_data!(Register(_, 32, 1, _, _)),
                match_data!(Register(_, 32, 2, _, _)),
                None,
            ),
        ) => {
            // ---
        ...
        (
            ...
            Operands(
                match_data!(Register(_, 64, _, _, _)),
                match_data!(Register(_, _, _, _, RegType::SReg)),
                None,
                None,
            ),
        ) => {
        ...
        (
            ...
            Operands(
                match_data!(Register(_, 64, _, _, _)),
                match_data!(Register(_, _, _, _, RegType::CReg)),
                None,
                None,
            ),
        ) => {
        ...
        (
            ...
            Operands(
                match_data!(Register(_, 64, _, _, _)),
                match_data!(Register(_, _, _, _, RegType::DReg)),
                None,
                None,
            ),
        ) => {
        ...
        (
            ...
            Operands(
                match_data!(Register(_, 64, _, _, _)),
                match_data!(Register(_, 8, _, _, _)) | match_data!(Memory { size: 8, .. }),
                None,
                None,
            ),
        ) => {
        ...
        (
            ...
            Operands(
                match_data!(Register(_, 64, _, _, _)),
                match_data!(Register(_, 16, _, _, _)) | match_data!(Memory { size: 16, .. }),
                None,
                None,
            ),
        ) => {
        ...
        (
            ...
            Operands(
                match_data!(Register(_, 64, _, _, _)),
                match_data!(Register(_, 32, _, _, _)) | match_data!(Memory { size: 32, .. }),
                None,
                None,
            ),
        ) => {
