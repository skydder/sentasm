import sys
from .lib import Match, Defun, FunCall, display_list
...
def read_grammar(path:str) -> list:
    with open(path) as file:
        return read(tokenize_grammar(file.read()))
...
def gen_codegen_verb(verb: list[str]) -> str:
    params = [('verb', 'Verb'), ('verb_loc', 'Loc'), ('object', 'Option<DataSet>'), ('preposition_phrases', '&mut PrepositionPhrases')]
    ...
    match_sentence = Match('verb', match_patterns).match()
...
if __name__ == '__main__':
    with open('grammar.dat') as file:
        ...
        print()
        print(gen_macro())
        # codegen = Defun('codegen_ins', [('_verb', 'Verb'), ('_verb_loc', 'Loc'), ('_object', 'Option<DataSet>'), ('_preposition_phrases', '&mut PrepositionPhrases')])
